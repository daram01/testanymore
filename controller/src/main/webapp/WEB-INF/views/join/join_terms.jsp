									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<input type="checkbox">
												<label class="label" for="#">개인정보 수집 및 이용 동의</label>
												<textarea name="message" class="form-control" id="message" cols="30" rows="10" readonly>
1. 개인정보의 수집항목 및 수집방법 
    ...
    - 행정자치부
      ...
      · 개인정보 보유 및 이용 기간 : 행정자치부에서는 이미 보유하고 있는 개인정보이기 때문에 별도로 저장하지 않음
										...
										<div class="col-md-12">
											<div class="form-group">
												<input type="checkbox">
												<label class="label" for="#">서비스 약관 동의</label>
												<textarea name="message" class="form-control" id="message" cols="30" rows="10" readonly>
제 1 장 총칙
...
(시행일) 본 약관은 2018년 8월 1일부터 시행됩니다. 개정된 약관의 적용일자 이전 이용자 또는 회원은 개정된 이용약관의 적용을 받습니다.
										...
										<div class="col-md-12">
											<div class="form-group">
												...
												<a href="/join/join_form"><input type="button" value="다음" class="btn btn-primary"></a>
